...
export interface Holding {
  ...
  price: number;
  value: number;
  source: "NSDL" | "CDSL" | "DFM" | "ADX" | "DFM/ADX Custodian" | "PSE" | "PSE Custodian" | "SGX" | "SGX Custodian";
...
export interface PortfolioParseResult {
  source: "NSDL" | "CDSL" | "DFM" | "ADX" | "DFM/ADX Custodian" | "PSE" | "PSE Custodian" | "SGX" | "SGX Custodian" | "Unknown";
  asOf?: string;
  investor?: string;
  pan?: string;
  holdings: Holding[];
